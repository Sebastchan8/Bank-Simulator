// src/funciones/pdf_generator/pdf_builder.js
const fileReader = require('./file_reader');
const puppeteer = require('./puppeteer_pdf');

exports.generatePDF = async (nombreCredito, metodo, tasaAnual, monto, periodoMeses, seguro, tabla, totalInteres) => {
    ...
    await puppeteer.generatePDF(html,`Reporte Amortización (${metodo})`);
}
